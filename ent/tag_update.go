...
func (tu *TagUpdate) SetChinese(s string) *TagUpdate {
	tu.mutation.SetChinese(s)
	return tu
}

// SetNillableChinese sets the "chinese" field if the given value is not nil.
func (tu *TagUpdate) SetNillableChinese(s *string) *TagUpdate {
	if s != nil {
		tu.SetChinese(*s)
	}
	return tu
...
func (tu *TagUpdate) sqlSave(ctx context.Context) (n int, err error) {
	_spec := sqlgraph.NewUpdateSpec(tag.Table, tag.Columns, sqlgraph.NewFieldSpec(tag.FieldID, field.TypeInt32))
	...
	if value, ok := tu.mutation.Chinese(); ok {
...
// SetChinese sets the "chinese" field.
func (tuo *TagUpdateOne) SetChinese(s string) *TagUpdateOne {
	tuo.mutation.SetChinese(s)
	return tuo
}

// SetNillableChinese sets the "chinese" field if the given value is not nil.
func (tuo *TagUpdateOne) SetNillableChinese(s *string) *TagUpdateOne {
	if s != nil {
		tuo.SetChinese(*s)
	}
	return tuo
...
func (tuo *TagUpdateOne) sqlSave(ctx context.Context) (_node *Tag, err error) {
	...
	if value, ok := tuo.mutation.Chinese(); ok {
		_spec.SetField(tag.FieldChinese, field.TypeString, value)
	}
