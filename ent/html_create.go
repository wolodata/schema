...
func (hc *HTMLCreate) SetID(i int32) *HTMLCreate {
	hc.mutation.SetID(i)
	return hc
}
...
func (hc *HTMLCreate) createSpec() (*Html, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(html.Table, sqlgraph.NewFieldSpec(html.FieldID, field.TypeInt32))
	)
...
func (u *HtmlUpsertOne) ID(ctx context.Context) (id int32, err error) {
...
func (u *HtmlUpsertOne) IDX(ctx context.Context) int32 {
	id, err := u.ID(ctx)
	if err != nil {
		panic(err)
	}
