...
func (scq *SystemConfigQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (scq *SystemConfigQuery) FirstIDX(ctx context.Context) string {
...
func (scq *SystemConfigQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (scq *SystemConfigQuery) OnlyIDX(ctx context.Context) string {
...
func (scq *SystemConfigQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (scq *SystemConfigQuery) IDsX(ctx context.Context) []string {
	ids, err := scq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(systemconfig.FieldName).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
func (scq *SystemConfigQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(systemconfig.Table, systemconfig.Columns, sqlgraph.NewFieldSpec(systemconfig.FieldID, field.TypeString))
	_spec.From = scq.sql
